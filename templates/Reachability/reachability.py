...
class Mechanism:        # Class for defining Mechanism Should be named Mechanism, must follow naming conventions
    ...
    def checkReachability(self):        #Mechanism Function to be deployed, this name must be passed in template policy deploy key

        host_switch_rel = input("Enter Relation between Host & Switches\n")
        switch_switch_rel = input("Enter relation between Switch & Switch\n")
